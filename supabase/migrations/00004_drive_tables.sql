...
-- Create indexes
CREATE INDEX idx_drive_accounts_user_id ON drive_accounts(user_id);
CREATE INDEX idx_drive_accounts_google_id ON drive_accounts(google_account_id);
CREATE INDEX idx_monitored_folders_account_id ON monitored_folders(drive_account_id);
CREATE INDEX idx_monitored_folders_active ON monitored_folders(is_active);
CREATE INDEX idx_drive_files_folder_id ON drive_files(monitored_folder_id);
CREATE INDEX idx_drive_files_available ON drive_files(is_available, is_blacklisted);
CREATE INDEX idx_drive_files_last_used ON drive_files(last_used_at);
CREATE INDEX idx_file_cache_drive_file_id ON file_cache(drive_file_id);
CREATE INDEX idx_file_cache_expires_at ON file_cache(expires_at);
CREATE INDEX idx_scan_history_folder_id ON scan_history(monitored_folder_id);
...
-- Trigger to update folder counts
...
-- Users can only access their own Drive accounts
